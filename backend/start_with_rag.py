...
def main():
    ...
    try:
        ...
        if success:
            ...
            response = ai_service.generate_response("Qu'est-ce que la constitution?", "Guinee-Constitution-2010.pdf")
            ...
            logger.info("🔄 Processus maintenu en vie...")
            import time
            while True:
                time.sleep(60)  # Attendre 1 minute
                logger.info("💓 Processus RAG toujours actif...")
