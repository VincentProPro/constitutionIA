  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {/* Section principale - Layout mobile-first */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {/* Logo et description - Pleine largeur sur mobile */}
          <div className="col-span-1 sm:col-span-2">
            <div className="flex items-center space-x-2 mb-3 sm:mb-4">
              ...
              <span className="text-lg sm:text-xl font-bold text-white">ConstitutionIA</span>
            </div>
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xs sm:text-sm font-semibold text-gray-400 tracking-wider uppercase mb-3 sm:mb-4">
              Navigation
            </h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/constitutions" className="text-gray-300 hover:text-white text-sm sm:text-base transition-colors">
                  Constitutions
                </Link>
              </li>
            </ul>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 text-sm sm:text-base">
                ...
                <a href="mailto:contact@constitutionia.gn" className="hover:text-white transition-colors break-all">
                  contact@constitutionia.gn
                </a>
              </li>
              <li className="text-gray-300 text-sm sm:text-base">
                <span className="block font-medium">Téléphone:</span>
                <a href="tel:+224123456789" className="hover:text-white transition-colors">
                  +224 123 456 789
                </a>
              </li>
              <li className="text-gray-300 text-sm sm:text-base">
        ...
        {/* Section blanche avec les logos - Layout mobile optimisé */}
        <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-gray-300 bg-white rounded-lg p-4 sm:p-6">
